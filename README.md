...
# Discord Youtube Fix 1.8.0

### YouTube Unban · Discord connecting / RTC · обход DPI без VPN

**[coalarbiterprize/discord-youtube-fix-1.8.0](https://github.com/coalarbiterprize/discord-youtube-fix-1.8.0)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/coalarbiterprize/discord-youtube-fix-1.8.0/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `coalarbiterprize/discord-youtube-fix-1.8.0`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/coalarbiterprize/discord-youtube-fix-1.8.0/releases/latest) и скачайте **`.rar`** (предпочтительно)
